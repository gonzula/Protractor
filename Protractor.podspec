#
#  Be sure to run `pod spec lint Protractor.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Gonzo Fialho"
  # s.authors            = { "Gonzo Fialho" => "carloseaf@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Gonzo Fialho"
